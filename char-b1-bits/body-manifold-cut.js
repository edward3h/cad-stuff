...
const cutout2d = new CrossSection([[
  [-1,lbotright+2],
  [0,lbotright],
  [h+1,ltopright+5],
  [h+1,ltoprear-5], 
...
const cutout3d = cutout2d.extrude(w+2).rotate([0,-90,0]).translate([1,0,0]);

const result = leftx.subtract(rightx).subtract(cutout3d);

const hull = new GLTFNode();
hull.manifold = result;
hull.material = {baseColorFactor: [0.03,0.1,0.02], metallic: 0.1, roughness: 0.3};

// const testNode = new GLTFNode();
// testNode.manifold = cutout3d;
// testNode.material = {baseColorFactor: [1,0,0], metallic: 0.1, roughness: 0.3};